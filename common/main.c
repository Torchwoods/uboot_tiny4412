...
//		printf("debug-1");
		if(strstr(p,"version=4.2.2")){
			...
			setenv("bootcmd","movi read kernel 0 40008000;fatload mmc 1:1 0x41000000 ramdisk-4.0.4.img;bootm 40008000 41000000");
		}else if(strstr(p,"version=2.3.7")){
			setenv("bootcmd","movi read kernel 0 40008000;fatload mmc 1:1 0x41000000 ramdisk-2.3.7.img;bootm 40008000 41000000");
		}else{
			setenv("bootcmd","movi read kernel 0 40008000;movi read rootfs 0 41000000 100000;bootm 40008000 41000000");
		}
	}else{
...
//	cmd_buf = getenv("bootcmd");
//	printf("ConfigBootCmd:%s\n",p);
//	printf("BootCmd:%s\n",cmd_buf);
}
/////////////////////////////////////////////////////////
/****************************************************************************/
