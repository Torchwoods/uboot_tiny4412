...
/*
#define CONFIG_BOOTCOMMAND	"movi read kernel 0 40008000;bootm 40008000"
#define CONFIG_BOOTARGS	"root=/dev/mmcblk0p2 console=ttySAC0,115200n8 androidboot.console=ttySAC0 ctp=2 skipcali=y vmalloc=512m"
*/
